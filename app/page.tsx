      ...
      <main className="flex-1">
            ...
            <div className="max-w-3xl mx-auto text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <AuthButton
                  ...
                  className="w-full sm:w-auto bg-black text-white hover:bg-gray-700 px-4 py-3 rounded-lg transition-colors duration-200 flex items-center justify-center cursor-pointer"
                >
                  {isLoggedIn ? (
                    "Check it Out"
                  ) : (
        ...
        <section className="py-16 md:py-24 bg-gray-800">
          <div className="container mx-auto px-4 text-center">
            ...
            <AuthButton
              isLoggedIn={isLoggedIn}
              className="inline-block bg-white text-gray-800 hover:bg-blue-50 px-6 py-3 rounded-lg transition-colors duration-200 cursor-pointer"
            >
